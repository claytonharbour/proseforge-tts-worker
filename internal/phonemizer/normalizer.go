...
func NormalizeText(text string) string {
	...
	// Expand decades: 1990s → nineteen nineties
...
// expandAcronym spells out uppercase letter sequences: CEO → C E O.
// Only expands sequences that aren't common words (e.g., skips AM, PM, IT, etc.).
func expandAcronym(s string) string {
	// Skip common uppercase words that aren't acronyms
	switch s {
	case "AM", "PM", "OK", "IT", "IS", "IN", "ON", "OR", "AN", "AS",
