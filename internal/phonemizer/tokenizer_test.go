...
func TestSplitSentencesAbbreviations(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"Dr. does not split",
			"Dr. Smith went home.",
			[]string{"Dr. Smith went home."},
		},
		{
			"Mr. does not split",
			"Mr. Jones arrived early.",
			[]string{"Mr. Jones arrived early."},
		},
		{
			"Mrs. does not split",
			"Mrs. Clark called yesterday.",
			[]string{"Mrs. Clark called yesterday."},
		},
		{
			"Ms. does not split",
			"Ms. Taylor is here.",
			[]string{"Ms. Taylor is here."},
		},
		{
			"multiple abbreviations in one sentence",
			"Dr. Smith met Mr. Jones and Mrs. Clark.",
			[]string{"Dr. Smith met Mr. Jones and Mrs. Clark."},
		},
		{
			"abbreviation then real sentence boundary",
			"Dr. Smith left. He went home.",
			[]string{"Dr. Smith left.", "He went home."},
		},
		{
			"Prof. does not split",
			"Prof. Adams taught the class.",
			[]string{"Prof. Adams taught the class."},
		},
		{
			"etc. does not split mid-sentence",
			"We need food, water, etc. for the trip.",
			[]string{"We need food, water, etc. for the trip."},
		},
		{
			"case insensitive - dr. lowercase",
			"The dr. was late.",
			[]string{"The dr. was late."},
		},
		{
			"Gen. and Lt. military ranks",
			"Gen. Patton outranked Lt. Smith.",
			[]string{"Gen. Patton outranked Lt. Smith."},
		},
	}
